  ...
  return (
    <div style={{
      ...
      <button
        ...
        onClick={() => window.bridge && window.bridge.createRestorePoint && window.bridge.createRestorePoint()}
      >
        {icons.shield}
      ...
      <button
        ...
        onClick={() => window.bridge && window.bridge.exitApp && window.bridge.exitApp()}
      >
        {icons.logout}
        SAIR
      </button>
